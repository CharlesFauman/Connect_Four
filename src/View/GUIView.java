...
public class GUIView extends View{
	...
	public GUIView(int width, int height, int connect_number) {
		...
		ImageIcon connect_4_board_image = new ImageIcon("src/Resources/connect_4_board.png");
	...
	public void PlayMove(int column, int row) {
		...
		if(player_turn == 1) piece_image = new ImageIcon("src/Resources/X_puck.png");
		else piece_image = new ImageIcon("src/Resources/O_puck.png");
